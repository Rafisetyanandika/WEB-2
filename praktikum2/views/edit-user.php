                                ...
                                <form action="edit-user.php?id=<?php echo $user['id'] ?>" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            id="laki-laki" name="gender" value="laki-laki" required                                                                                                                                                                                                       <?php echo $user['gender'] == 'laki-laki' ? 'checked' : '' ?>/>
                                            <label for="laki-laki" class="form-check-label" >Laki-laki</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input type="radio" class="form-check-input"
                                            id="perempuan" name="gender" value="perempuan" required                                                                                                                                                                                                       <?php echo $user['gender'] == 'perempuan' ? 'checked' : '' ?>/>
                                            <label for="perempuan" class="form-check-label">Perempuan</label>
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="age" class="form-label">Age</label>
                                        <input type="number" class="form-control" id="age" name="age" min="0" max="100" value="<?php echo $user['age'] ?>" required />
                                    </div>
                                    <div class="mb-3">
                                        <label for="weight" class="form-label">Weight</label>
                                        <input type="number" class="form-control" id="weight" name="weight" min="0" max="100" value="<?php echo $user['weight'] ?>" required />
                                    </div>
